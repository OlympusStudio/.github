...
[![Tech Stack](https://skillicons.dev/icons?i=ts,nodejs,react,tailwind,postgres,redis,mongodb,docker,linux,cloudflare,github,git,python)](https://skillicons.dev)
